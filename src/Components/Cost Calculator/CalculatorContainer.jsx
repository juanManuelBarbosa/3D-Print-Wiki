...
const CalculatorContainer = ({ theme, changeTheme }) => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <Header
                headerBanner="https://i.ibb.co/FJPNgFC/Banner-de-Linked-In-Trabajo-Sencillo-3.png"
                headerText="Herramienta que sirve para establecer un precio adecuado que puedes usar de referencia para tus piezas..."
                theme={theme}
            />

            <div className="flex gap-2 flex-col md:flex-row flex-1">
                <section className="basis-1/2 p-5 m-4 border border-fuchsia-950 border-3 rounded-lg bg-slate-950/40 sm:basis-[70%]">
